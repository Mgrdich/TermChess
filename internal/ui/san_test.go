...
func TestFormatSAN(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			move: engine.Move{
				From: parseSquareHelper("e2"),
				To:   parseSquareHelper("e4"),
			},
			expected: "e2e4",
		},
		{
			name: "knight move",
			move: engine.Move{
				From: parseSquareHelper("g1"),
				To:   parseSquareHelper("f3"),
			},
			expected: "g1f3",
		},
		{
			name: "bishop move",
			move: engine.Move{
				From: parseSquareHelper("f1"),
				To:   parseSquareHelper("c4"),
			},
			expected: "f1c4",
		},
		{
			name: "rook move",
			move: engine.Move{
				From: parseSquareHelper("a1"),
				To:   parseSquareHelper("a3"),
			},
			expected: "a1a3",
		},
		{
			name: "queen move",
			move: engine.Move{
				From: parseSquareHelper("d1"),
				To:   parseSquareHelper("h5"),
			},
			expected: "d1h5",
		},
		{
			name: "king move",
			move: engine.Move{
				From: parseSquareHelper("e1"),
				To:   parseSquareHelper("e2"),
			},
			expected: "e1e2",
		},
		{
		...
		},
		{
			...
			move: engine.Move{
				From:      parseSquareHelper("a7"),
				To:        parseSquareHelper("a8"),
				Promotion: engine.Rook,
			},
			expected: "a7a8=R",
		},
		{
			...
			move: engine.Move{
				From:      parseSquareHelper("h7"),
				To:        parseSquareHelper("h8"),
				Promotion: engine.Bishop,
			},
			expected: "h7h8=B",
		},
		{
			...
			move: engine.Move{
				From:      parseSquareHelper("b7"),
				To:        parseSquareHelper("b8"),
				Promotion: engine.Knight,
			},
			expected: "b7b8=N",
		},
		{
			...
			move: engine.Move{
				From:      parseSquareHelper("e7"),
				To:        parseSquareHelper("d8"),
				Promotion: engine.Queen,
			},
			expected: "e7d8=Q",
		},
		{
			name: "castling kingside (white)",
			move: engine.Move{
				From: parseSquareHelper("e1"),
				To:   parseSquareHelper("g1"),
			},
			expected: "e1g1",
		},
		{
			name: "castling queenside (black)",
			move: engine.Move{
				From: parseSquareHelper("e8"),
				To:   parseSquareHelper("c8"),
			},
			expected: "e8c8",
		},
	}
...
// TestFormatMoveHistory tests the FormatMoveHistory function for formatting move sequences.
func TestFormatMoveHistory(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "empty move history",
			moves:    []engine.Move{},
			expected: "",
		},
		{
			name: "single move (white only)",
			moves: []engine.Move{
		...
		{
			name: "one complete move pair",
			moves: []engine.Move{
				{From: parseSquareHelper("e2"), To: parseSquareHelper("e4")},
				{From: parseSquareHelper("e7"), To: parseSquareHelper("e5")},
			},
			expected: "1. e2e4 e7e5 ",
		},
		{
			name: "two complete move pairs",
			moves: []engine.Move{
				{From: parseSquareHelper("e2"), To: parseSquareHelper("e4")},
				{From: parseSquareHelper("e7"), To: parseSquareHelper("e5")},
			...
			expected: "1. e2e4 e7e5 2. g1f3 b8c6 ",
		},
		{
			name: "three moves (white has extra move)",
			moves: []engine.Move{
				{From: parseSquareHelper("e2"), To: parseSquareHelper("e4")},
				{From: parseSquareHelper("e7"), To: parseSquareHelper("e5")},
				{From: parseSquareHelper("g1"), To: parseSquareHelper("f3")},
		...
		{
			name: "moves with promotion",
			moves: []engine.Move{
				{From: parseSquareHelper("e2"), To: parseSquareHelper("e4")},
				{From: parseSquareHelper("e7"), To: parseSquareHelper("e5")},
				{From: parseSquareHelper("a7"), To: parseSquareHelper("a8"), Promotion: engine.Queen},
			},
			expected: "1. e2e4 e7e5 2. a7a8=Q",
		},
		{
			name: "typical opening sequence",
			moves: []engine.Move{
				{From: parseSquareHelper("e2"), To: parseSquareHelper("e4")},
				{From: parseSquareHelper("e7"), To: parseSquareHelper("e5")},
				{From: parseSquareHelper("g1"), To: parseSquareHelper("f3")},
				{From: parseSquareHelper("b8"), To: parseSquareHelper("c6")},
				{From: parseSquareHelper("f1"), To: parseSquareHelper("c4")},
				{From: parseSquareHelper("f8"), To: parseSquareHelper("c5")},
			},
			expected: "1. e2e4 e7e5 2. g1f3 b8c6 3. f1c4 f8c5 ",
		},
		{
			name: "many moves (10 moves)",
			moves: []engine.Move{
				{From: parseSquareHelper("e2"), To: parseSquareHelper("e4")},
				{From: parseSquareHelper("e7"), To: parseSquareHelper("e5")},
				{From: parseSquareHelper("g1"), To: parseSquareHelper("f3")},
				...
				{From: parseSquareHelper("f1"), To: parseSquareHelper("c4")},
				{From: parseSquareHelper("f8"), To: parseSquareHelper("c5")},
				{From: parseSquareHelper("d2"), To: parseSquareHelper("d3")},
				{From: parseSquareHelper("d7"), To: parseSquareHelper("d6")},
				{From: parseSquareHelper("b1"), To: parseSquareHelper("c3")},
				{From: parseSquareHelper("g8"), To: parseSquareHelper("f6")},
			},
			expected: "1. e2e4 e7e5 2. g1f3 b8c6 3. f1c4 f8c5 4. d2d3 d7d6 5. b1c3 g8f6 ",
		},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := FormatMoveHistory(tt.moves)
			if result != tt.expected {
				t.Errorf("expected '%s', got '%s'", tt.expected, result)
			}
		})
