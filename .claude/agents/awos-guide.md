---
name: awos-guide
description: Use this agent when the user asks questions about AWOS (Agentic Workflow Operating System), needs help understanding AWOS workflow, wants to know what AWOS does, asks about files in the .awos folder, needs guidance on AWOS specs, or requires detailed explanations of AWOS functionality and the seven-stage workflow (product, roadmap, architecture, spec, tech, tasks, implement).
